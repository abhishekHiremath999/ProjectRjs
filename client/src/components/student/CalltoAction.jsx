...
export const CalltoAction = () => {
  return (
    ...
    <h1 className='text-xl md:text-4xl text-gray-800 font-semibold'>  Learn anything, anytime, anywhere </h1>
        <p className='text-gray-500 sm:text-sm'>Incident sint fugiat pariatur cupidatat consectetur sit
          cillium anim  id veniam aliqua proidant exceptur commondo do
          ea.
        </p>
