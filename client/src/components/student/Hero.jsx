...
const Hero = () => {
  return (
    ...
    px-7 md:px-0 space-y-7 text-center bg-gradient-to-b from-cyan-100/70'>
        <h1 className='md:text-home-heading-large text-home-heading-small relative font-bold text-grey-800
        max-w-3x1 mx-auto'>
      ...
      <p className='md:block hidden text-grey-500 max-w-2x1 mx-auto'>We
        bring together world-class instructors, interactive content, and asupportive 
        commity to help you achieve your personal and proffesional goals.
      </p>
